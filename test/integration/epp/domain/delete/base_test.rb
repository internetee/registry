  ...
  def test_bypasses_domain_and_registrant_and_contacts_validation
    ...
    request_xml = <<-XML
      ...
      <epp xmlns="#{Xsd::Schema.filename(for_prefix: 'epp-ee', for_version: '1.0')}">
        <command>
          <delete>
            <domain:delete xmlns:domain="#{Xsd::Schema.filename(for_prefix: 'domain-ee', for_version: '1.1')}">
  ...
  def test_skips_registrant_confirmation_when_required_but_already_verified_by_registrar
    ...
    request_xml = <<-XML
      ...
      <epp xmlns="#{Xsd::Schema.filename(for_prefix: 'epp-ee', for_version: '1.0')}">
        <command>
          <delete>
            <domain:delete verified="yes" xmlns:domain="#{Xsd::Schema.filename(for_prefix: 'domain-ee', for_version: '1.1')}">
              <domain:name>shop.test</domain:name>
            </domain:delete>
          </delete>
          <extension>
