class Registrar
  class SessionsController < Devise::SessionsController
    ...
    def mid
      ...
      @user = if Setting.registrar_ip_whitelist_enabled
                find_user_by_idc_and_allowed(response.user_id_code)
              else
                find_user_by_idc(response.user_id_code)
              end
    ...
    def depp_user_params
      ...
      params[:pki] = !(Rails.env.development? || Rails.env.test?)
      params
    end
