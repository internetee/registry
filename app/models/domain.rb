...
class Domain < ActiveRecord::Base
  ...
  def pending_update!
    ...
    DomainMailer.pending_update_request_for_old_registrant(id, old_registrant_id, new_registrant_id, deliver_emails).deliver
    DomainMailer.pending_update_notification_for_new_registrant(id, old_registrant_id, new_registrant_id, deliver_emails).deliver
