class Directo < ActiveRecord::Base
  ...
  def self.send_monthly_invoices(debug: false)
    I18n.locale    = :et
    month          = Time.now.in_time_zone - 1.month
    ...
    Registrar.where.not(test_registrar: true).find_each do |registrar|
      ...
      registrar_activities.where(activity_type: [AccountActivity::CREATE, AccountActivity::RENEW]).find_each do |activity|
        ...
        builder = Nokogiri::XML::Builder.new(encoding: 'UTF-8') do |xml|
          xml.invoices do
            xml.invoice('Number' => directo_next,
                        ...
                        'SalesAgent' => Setting.directo_sales_agent) do
