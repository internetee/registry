...
(function() {
  this.Autocomplete = (function() {
    function Autocomplete() {
      ...
      for (i = 0, len = ref.length; i < len; i++) {
        el = ref[i];
        this.buildAutocomplete(el);
      }
    }

    Autocomplete.prototype.buildAutocomplete = function(el) {
      var name;
      name = el.dataset.autocomplete.slice(1).replace(/\//g, "_");
      ...
      return $(el).typeahead({
        ...
        source: function(query, syncResults) {
          return $.getJSON(el.dataset.autocomplete + "?query=" + query, function(data) {
