\restrict 1nctSeWgAMeDygPpYdyeGcpf3SIlnwVyJaYVgeIkZgsmRdEvwgJ7hEgebG5zQ3v
...
--
-- Name: bounced_mail_addresses id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: bounced_mail_addresses bounced_mail_addresses_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: index_log_domains_on_event; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_log_domains_on_event ON public.log_domains USING btree (event);
...
\unrestrict 1nctSeWgAMeDygPpYdyeGcpf3SIlnwVyJaYVgeIkZgsmRdEvwgJ7hEgebG5zQ3v
