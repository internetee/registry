...
--
-- Name: uniq_contact_of_type_per_domain; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX uniq_contact_of_type_per_domain ON public.domain_contacts USING btree (domain_id, type, contact_id);


--
-- Name: uniq_hostname_per_domain; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX uniq_hostname_per_domain ON public.nameservers USING btree (domain_id, hostname);
